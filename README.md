...
Online photography course by Yulia Sitdikova — a Tilda landing page, exported as a static site.
...
- Archived from https://authorscourse.tilda.ws/, then repackaged: the saved asset folder was renamed
